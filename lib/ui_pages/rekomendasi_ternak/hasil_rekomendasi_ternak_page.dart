...
// Halaman Utama
class HasilRekomendasiTernakPage extends StatefulWidget {
  const HasilRekomendasiTernakPage({super.key});

  @override
  HasilRekomendasiTernakPageState createState() => HasilRekomendasiTernakPageState();
}

class HasilRekomendasiTernakPageState extends State<HasilRekomendasiTernakPage> {
